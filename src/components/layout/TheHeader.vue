<template>
  <div class="header">
    ...
    <div class="center">
      <!-- <img class="text-logo" src="../../assets/images/netease11.png" alt=""> -->
    </div>
    <div class="right">
      <div class="search-wrapper">
        <input class="search" @keyup.enter="search" type="text" v-model="keywords" placeholder="Song Artist Album" />
...
.header {
  ...
  .center {
    width: 300px;
    height: 50px;
    background: url("../../assets/images/netease.png") no-repeat top center;
