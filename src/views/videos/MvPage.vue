  ...
  <div class="mv-wrapper content-vertical-align">
    ...
    <div class="related-mvs">
      <div class="one-mv" v-for="item in similarMvs" :key="item.id">
        <MvCard :height="'120px'" :caption="item.copywriter" :picUrl="item.cover" :playCount="item.playCount"
          :mvId="item.id" :duration="$helpers.convertMsToMinutes(item.duration)"></MvCard>
