  ...
  <div class="artists">
    <div class="category-tabs">
      <div class="area-tabs">
        ...
        <ul>
          <li v-for="(area, index) in areaTabs" :key="area" :class="{ active: index === filterIdx.area }"
      ...
      <div class="type-tabs">
        ...
        <ul>
          <li v-for="(type, index) in typeTabs" :key="type" :class="{ active: index === filterIdx.type }"
      ...
      <div class="sort-tabs">
        ...
        <ul>
          <li v-for="(char, index) in sortTabs" :key="char" :class="{ active: index === filterIdx.initial }"
    ...
    <el-pagination v-if="artists.length > 0" background layout="prev, pager, next" :total="1000"
...
export default {
  ...
  methods: {
    ...
    setPageIndex(pageIdx) {
      this.filter = {
        ...this.filter,
        offset: this.filter.limit * (pageIdx - 1)
      };
    },
